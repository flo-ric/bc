...
namespace scene
{
	...
	TCoordScale1(1.0f), TCoordScale2(1.0f), SmoothFactor(0), FileSystem(fs), dev(device)
	{
		...
		Mesh = new SMesh();
		RenderBuffer = new BCDynamicMeshBuffer(video::EVT_2TCOORDS, video::EIT_16BIT);
	...
	//! Initializes the terrain data. Loads the vertices from the heightMapFile
	bool BCTerrainSceneNode::loadHeightMapRAW(io::IReadFile* file,
	...
	video::SMaterial& BCTerrainSceneNode::getMaterial(u32 i)
	{
	...
	u32 BCTerrainSceneNode::getMaterialCount() const
	{
	...
	void BCTerrainSceneNode::setScale(const core::vector3df& scale)
	{
	...
	void BCTerrainSceneNode::setRotation(const core::vector3df& rotation)
	{
	...
	void BCTerrainSceneNode::setRotationPivot(const core::vector3df& pivot)
	{
	...
	void BCTerrainSceneNode::setPosition(const core::vector3df& newpos)
	{
	...
	void BCTerrainSceneNode::applyTransformation()
	{
	...
	void BCTerrainSceneNode::OnRegisterSceneNode()
	{
	...
	void BCTerrainSceneNode::preRenderCalculationsIfNeeded()
	{
	...
	void BCTerrainSceneNode::preRenderLODCalculations()
	{
		scene::ICameraSceneNode * camera = SceneManager->getActiveCamera();
	...
	void BCTerrainSceneNode::preRenderIndicesCalculations()
	{
		...
		{
			BCTerrainTriangleSelector* selector = (BCTerrainTriangleSelector*)TriangleSelector;
	...
	void BCTerrainSceneNode::render()
	{
		if (!IsVisible || !SceneManager->getActiveCamera())
			return;
	...
	const core::aabbox3d<f32>& BCTerrainSceneNode::getBoundingBox() const
	{
	...
	const core::aabbox3d<f32>& BCTerrainSceneNode::getBoundingBox(s32 patchX, s32 patchZ) const
	{
	...
	void BCTerrainSceneNode::getMeshBufferForLOD(IDynamicMeshBuffer& mb, s32 LOD ) const
	{
		if (!Mesh->getMeshBufferCount())
			return;
	...
	s32 BCTerrainSceneNode::getIndicesForPatch(core::array<u32>& indices, s32 patchX, s32 patchZ, s32 LOD)
	{
	...
	s32 BCTerrainSceneNode::getCurrentLODOfPatches(core::array<s32>& LODs) const
	{
		s32 numLODs;
		LODs.clear();
	...
	void BCTerrainSceneNode::setLODOfPatch(s32 patchX, s32 patchZ, s32 LOD)
	{
	...
	//! is rendered at.
	bool BCTerrainSceneNode::overrideLODDistance(s32 LOD, f64 newDistance)
	{
	...
	void BCTerrainSceneNode::scaleTexture(f32 resolution, f32 resolution2)
	{
	...
	u32 BCTerrainSceneNode::getIndex(const s32 PatchX, const s32 PatchZ,
	...
	//! smooth the terrain
	void BCTerrainSceneNode::smoothTerrain(IDynamicMeshBuffer* mb, s32 smoothFactor)
	{
	...
	void BCTerrainSceneNode::calculateNormals(IDynamicMeshBuffer* mb)
	{
		s32 count;
	...
	void BCTerrainSceneNode::createPatches()
	{
	...
	void BCTerrainSceneNode::calculatePatchData()
	{
	...
	void BCTerrainSceneNode::calculateDistanceThresholds(bool scalechanged)
	{
	...
	void BCTerrainSceneNode::setCurrentLODOfPatches(s32 lod)
	{
		const s32 count = TerrainData.PatchCount * TerrainData.PatchCount;
	...
	void BCTerrainSceneNode::setCurrentLODOfPatches(const core::array<s32>& lodarray)
	{
		const s32 count = TerrainData.PatchCount * TerrainData.PatchCount;
		for (s32 i=0; i<count; ++i)
	...
	//! Gets the height
	f32 BCTerrainSceneNode::getHeight(f32 x, f32 z) const
	{
		if (!Mesh->getMeshBufferCount())
			return 0;
	...
	void BCTerrainSceneNode::serializeAttributes(io::IAttributes* out,
	...
	void BCTerrainSceneNode::deserializeAttributes(io::IAttributes* in,
	...
	ISceneNode* BCTerrainSceneNode::clone(ISceneNode* newParent, ISceneManager* newManager)
	{
		if (!newParent)
			newParent = Parent;
		if (!newManager)
