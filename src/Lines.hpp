...
class Lines
{
  ...
  void setLineStart(irr::scene::ISceneNode* lineStart, int nodeType, int id, bool networkLine = false, irr::s32 lineID = -1); //Set the start point of the line (default is most recently added line)
